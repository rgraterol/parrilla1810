class InsertProvincias < ActiveRecord::Migration
  def up
    change_column(:provincias, :created_at, :datetime, :null => true)
    change_column(:provincias, :updated_at, :datetime, :null => true)
    execute "
